...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        doubleZero = findViewById(R.id.zerozero)
        ...
        doubleZero.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "00"
                expressionText(str)
                resultText()
        ...
        one.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "1"
                expressionText(str)
                resultText()
        ...
        two.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "2"
                expressionText(str)
                resultText()
        ...
        three.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "3"
                expressionText(str)
                resultText()
        ...
        four.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "4"
                expressionText(str)
                resultText()
        ...
        five.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "5"
                expressionText(str)
                resultText()
        ...
        six.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "6"
                expressionText(str)
                resultText()
        ...
        seven.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "7"
                expressionText(str)
                resultText()
        ...
        eight.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "8"
                expressionText(str)
                resultText()
        ...
        nine.setOnClickListener{
            if(expression.text.toString().startsWith("0")){
                str = expression.text.toString().replace("00", "") + "9"
                expressionText(str)
                resultText()
